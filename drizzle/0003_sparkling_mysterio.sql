...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "portfolio_comments" ADD CONSTRAINT "portfolio_comments_post_id_portfolio_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."portfolio_posts"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
