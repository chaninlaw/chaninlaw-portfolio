      ...
      <div className='h-full relative w-full overflow-hidden bg-stone-900 flex flex-col rounded-lg'>
        ...
        >
          ...
          <div className='flex flex-col items-center relative z-20'>
            <h1 className='md:text-6xl text-xl text-white relative z-20 font-serif select-none'>Hi, I&apos;m Chanin</h1>
            <p className='mt-2 text-neutral-300 uppercase'>Frontend Developer</p>
            <div className='mt-4 max-w-lg text-center'>
              <p>
                &ldquo;Passionately crafting user interfaces, continuously evolving skills for myself and others, on an
                endless journey toward frontend development mastery.&rdquo;
              </p>
            </div>
          </div>
        </MotionDiv>
